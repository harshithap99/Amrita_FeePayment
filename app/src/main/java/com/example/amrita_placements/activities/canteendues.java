...
public class canteendues extends AppCompatActivity {
    Button formid;
    Button payid;
    TextView AMT;
    int flag = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.canteen_fines);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful())
                {
                    ...
                    if (documentSnapshot.exists()) {
                        ...
                        long amount_int;
                        amount = documentSnapshot.get("CANTEENFEES").toString();
                        amount_int = (long) documentSnapshot.get("CANTEENFEES");
                        if(amount_int>0)
                        {
                            flag=1;
    ...
    public void go_to_formpage()
    {
        ...
        bundle1.putString("type", "CANTEENFEES");
    ...
    public void go_to_payment()
    {
        ...
        Bundle bundle1 = new Bundle();
        bundle1.putString("user1", user1);
        bundle1.putString("whatfees", "CANTEENFEES");
