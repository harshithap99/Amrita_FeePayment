...
public class busfees extends AppCompatActivity {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful())
                {
                    ...
                    if (documentSnapshot.exists()) {
                        ...
                        long amount_int;
                        amount = documentSnapshot.get("BUSFEES").toString();
                        amount_int = (long) documentSnapshot.get("BUSFEES");
                        if(amount_int>0)
                        {
                            flag=1;
    ...
    public void go_to_formpage()
    {
        ...
        bundle1.putString("type", "BUSFEES");
    ...
    public void go_to_payment()
    {
        ...
        Bundle bundle1 = new Bundle();
        bundle1.putString("user1", user1);
        bundle1.putString("whatfees", "BUSFEES");
